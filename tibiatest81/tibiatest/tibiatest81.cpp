...
int main()
{
	...
	// getTargetName()
	std::cout << "getTargetName(): " << Tibia.getTargetName() << std::endl;

	// setFpsLimit()
	//Tibia.setFpsLimit(10);
	...
	// setRsaKey()
	//Tibia.setRsaKey(RSA_KEY_OPEN_TIBIA);

	// sendOpenContainer()
	//TibiaPacket.sendOpenContainer(6042, Tibia.getTargetLocation(), 3);
