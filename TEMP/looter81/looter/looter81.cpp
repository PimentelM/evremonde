...
{
	// open looter ini
	::ShellExecute(0, "open", "notepad.exe", looterIni.c_str(), "", 1);
}

void openHomepage()
{
	// open homepage
	::ShellExecute(0, "open", homepageUrl.c_str(), "", "", 1);
}
...
void showAbout()
{
	...
	// home page
	buffer << "Homepage:" << std::endl << "http://code.google.com/p/evremonde/";
