...
// hotkeys
const int HOTKEYS_OBJECT_BEGIN			= 0x00769208;
const int HOTKEYS_OBJECT_END			= 0x00769298; // BEGIN + (STEP_HOTKEY_OBJECT * MAX_HOTKEYS)
const int HOTKEYS_TEXT_BEGIN			= 0x007692C0;
const int HOTKEYS_TEXT_END				= 0x0076B6C0; // BEGIN + (STEP_HOTKEY_TEXT * MAX_HOTKEYS)
const int HOTKEYS_TYPE_BEGIN			= 0x007690E8; // HotkeyType_t
const int HOTKEYS_TYPE_END				= 0x00769178; // BEGIN + (STEP_HOTKEY_TYPE * MAX_HOTKEYS)
const int HOTKEYS_AUTOMATIC_BEGIN		= 0x00769298;
const int HOTKEYS_AUTOMATIC_END			= 0x007692BC; // BEGIN + (STEP_HOTKEY_AUTOMATIC * MAX_HOTKEYS)
...
// fps
static unsigned char FPS_1[8]	= {0x00, 0x00, 0x00, 0x00, 0xA4, 0x8B, 0x8F, 0x40}; // 4652090476587909120; estimated
static unsigned char FPS_10[8]	= {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x59, 0x40}; // 4636737291354636288
static unsigned char FPS_30[8]	= {0x00, 0x00, 0x00, 0x00, 0xA0, 0xAA, 0xAA, 0x40}; // 4629888066742386688
static unsigned char FPS_60[8]	= {0x00, 0x00, 0x00, 0xA0, 0xAA, 0xAA, 0x30, 0x40}; // 4625384467115016192
static unsigned char FPS_100[8]	= {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24, 0x40}; // 4621819117588971520
static unsigned char FPS_200[8]	= {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x40}; // 4617315517961601024
static unsigned char FPS_MAX[8]	= {0x00, 0x00, 0x00, 0x40, 0x1F, 0x40, 0x8F, 0x40}; // 4579949849020989440
...
{
	3608, 3614, 3615, 3616, 3617, // object ids of trees
