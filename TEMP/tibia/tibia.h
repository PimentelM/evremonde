...
public:
	...
	void doPlayerWalkTo(int toX, int toY, int toZ);
	void doPlayerStop();
	void doPlayerStopTo();
	...
	void setFullLight(bool enabled);
	void setLevelSpy(bool enabled);
	void setNameSpy(bool enabled);
	void setShowInvisibleCreatures(bool enabled);

	void setFpsLimit(unsigned char* fps);
	...
	void setPlayerGoTo(int x, int y, int z);
	...
	void setPlayerIsWalking(bool enabled);
	...
	void setTargetSkull(Skull_t skullId);
