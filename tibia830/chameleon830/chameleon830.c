/*
 * Chameleon for Tibia 8.30
 * by Evremonde
 * Last updated on 9/30/2008
 */
...
#define ID_TRAY_MENU_OUTFIT_MALE_CITIZEN				1101
#define ID_TRAY_MENU_OUTFIT_MALE_HUNTER					1102
#define ID_TRAY_MENU_OUTFIT_MALE_MAGE					1103
#define ID_TRAY_MENU_OUTFIT_MALE_KNIGHT					1104
#define ID_TRAY_MENU_OUTFIT_MALE_NOBLEMAN				1105
#define ID_TRAY_MENU_OUTFIT_MALE_SUMMONER				1106
#define ID_TRAY_MENU_OUTFIT_MALE_WARRIOR				1107
#define ID_TRAY_MENU_OUTFIT_MALE_BARBARIAN				1108
#define ID_TRAY_MENU_OUTFIT_MALE_DRUID					1109
#define ID_TRAY_MENU_OUTFIT_MALE_WIZARD					1110
#define ID_TRAY_MENU_OUTFIT_MALE_ORIENTAL				1111
#define ID_TRAY_MENU_OUTFIT_MALE_PIRATE					1112
#define ID_TRAY_MENU_OUTFIT_MALE_ASSASSIN				1113
#define ID_TRAY_MENU_OUTFIT_MALE_BEGGAR					1114
#define ID_TRAY_MENU_OUTFIT_MALE_SHAMAN					1115
#define ID_TRAY_MENU_OUTFIT_MALE_NORSEMAN				1116
#define ID_TRAY_MENU_OUTFIT_MALE_NIGHTMARE				1117
#define ID_TRAY_MENU_OUTFIT_MALE_JESTER					1118
#define ID_TRAY_MENU_OUTFIT_MALE_BROTHERHOOD			1119
#define ID_TRAY_MENU_OUTFIT_MALE_DEMONHUNTER			1120

#define ID_TRAY_MENU_OUTFIT_FEMALE_CITIZEN				1201
#define ID_TRAY_MENU_OUTFIT_FEMALE_HUNTER				1202
#define ID_TRAY_MENU_OUTFIT_FEMALE_MAGE					1203
#define ID_TRAY_MENU_OUTFIT_FEMALE_KNIGHT				1204
#define ID_TRAY_MENU_OUTFIT_FEMALE_NOBLEMAN				1205
#define ID_TRAY_MENU_OUTFIT_FEMALE_SUMMONER				1206
#define ID_TRAY_MENU_OUTFIT_FEMALE_WARRIOR				1207
#define ID_TRAY_MENU_OUTFIT_FEMALE_BARBARIAN			1208
#define ID_TRAY_MENU_OUTFIT_FEMALE_DRUID				1209
#define ID_TRAY_MENU_OUTFIT_FEMALE_WIZARD				1210
#define ID_TRAY_MENU_OUTFIT_FEMALE_ORIENTAL				1211
#define ID_TRAY_MENU_OUTFIT_FEMALE_PIRATE				1212
#define ID_TRAY_MENU_OUTFIT_FEMALE_ASSASSIN				1213
#define ID_TRAY_MENU_OUTFIT_FEMALE_BEGGAR				1214
#define ID_TRAY_MENU_OUTFIT_FEMALE_SHAMAN				1215
#define ID_TRAY_MENU_OUTFIT_FEMALE_NORSEMAN				1216
#define ID_TRAY_MENU_OUTFIT_FEMALE_NIGHTMARE			1217
#define ID_TRAY_MENU_OUTFIT_FEMALE_JESTER				1218
#define ID_TRAY_MENU_OUTFIT_FEMALE_BROTHERHOOD			1219
#define ID_TRAY_MENU_OUTFIT_FEMALE_DEMONHUNTER			1220

#define ID_TRAY_MENU_OUTFIT_OTHER_GAMEMASTER			1301
#define ID_TRAY_MENU_OUTFIT_OTHER_COMMUNITY_MAMANGER	1302
#define ID_TRAY_MENU_OUTFIT_OTHER_HERO					1303
#define ID_TRAY_MENU_OUTFIT_OTHER_FERUMBRAS				1304
#define ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_MALE			1305
#define ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_FEMALE			1306
#define ID_TRAY_MENU_OUTFIT_OTHER_OLD_MALE				1307
#define ID_TRAY_MENU_OUTFIT_OTHER_OLD_FEMALE			1308
#define ID_TRAY_MENU_OUTFIT_OTHER_SWIMMING				1309
...
// battlelist
#define BATTLELIST_BEGIN	0x0062AD50 // OffsetCreatureType
#define BATTLELIST_END		0x00630B10 // = BATTLELIST_BEGIN + (STEP_CREATURE * MAX_CREATURES)

// player
#define PLAYER_ID			0x0062ACF0 // unique id
...
// outfit colors
const int OUTFIT_COLORS_NEWBIE[4] = {78, 69, 58, 76}; // default newbie outfit colors
...
enum OutfitType
{
	...
	OUTFIT_INVISIBLE			= 0,	// outfit as item
...
// get player offset
int getPlayerOffset(int offset, int bytes)
{
	...
	for(i = BATTLELIST_BEGIN; i < BATTLELIST_END; i += STEP_CREATURE)
	{
		...
		if (creatureId == getPlayerId())
			return readBytes(i + offset, bytes); // set offset
	}
...
int getPlayerOutfitAddon()
	{ return getPlayerOffset(OFFSET_CREATURE_OUTFIT_ADDON, 1); }

// get player outfit colors
OutfitColors getPlayerOutfitColors()
{
	OutfitColors outfitColors;

	outfitColors.head = getPlayerOffset(OFFSET_CREATURE_OUTFIT_HEAD, 1);
	outfitColors.body = getPlayerOffset(OFFSET_CREATURE_OUTFIT_BODY, 1);
	outfitColors.legs = getPlayerOffset(OFFSET_CREATURE_OUTFIT_LEGS, 1);
	outfitColors.feet = getPlayerOffset(OFFSET_CREATURE_OUTFIT_FEET, 1);
...
// set player outfit
void setPlayerOutfit(int outfitType)
	{ setPlayerOffset(OFFSET_CREATURE_OUTFIT, outfitType, 2); }

// set player outfit addon
void setPlayerOutfitAddon(int outfitAddonType)
...
void doOutfitRandom()
{
	...
	// avoid client crash
	int i = 0;
	for (i = 0; i < sizeof(OUTFIT_ERROR); i++)
	{
		if (randomOutfit == OUTFIT_ERROR[i])
		{
			doOutfitRandom();
			return;
		}
...
void doRainbowToggle()
{
	...
	else
	{
		...
		setPlayerOutfitColors(outfitColors.head, outfitColors.body, outfitColors.legs, outfitColors.feet);
...
void doTrayIconCreate(HWND hwnd)
{
	...
	strcpy(trayIcon.szTip, "Chameleon - Tibia 8.30");
...
void doTrayMenuCreate(HWND hwnd)
{
	...
	AppendMenu(trayMenu, MF_STRING, ID_TRAY_MENU_NULL,									"Chameleon - Tibia 8.30");
	...
	AppendMenu(traySubMenu, MF_SEPARATOR, 0, 0);
	AppendMenu(traySubMenu, MF_STRING, ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_MALE,			"Newbie Male");
	AppendMenu(traySubMenu, MF_STRING, ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_FEMALE,			"Newbie Female");
	AppendMenu(traySubMenu, MF_SEPARATOR, 0, 0);
	...
	AppendMenu(trayMenu, MF_STRING, ID_TRAY_MENU_OUTFIT_ADDON,							"Outfit Addon");
	AppendMenu(trayMenu, MF_SEPARATOR, 0, 0);
	...
	// radio check tray menu items
	int outfitAddonMenu = 0;
	switch (outfitAddon)
	{
		case OUTFIT_ADDON_NONE:
			outfitAddonMenu = ID_TRAY_MENU_OUTFIT_ADDON_NONE;
			break;

		case OUTFIT_ADDON_1:
			outfitAddonMenu = ID_TRAY_MENU_OUTFIT_ADDON_1;
			break;

		case OUTFIT_ADDON_2:
			outfitAddonMenu = ID_TRAY_MENU_OUTFIT_ADDON_2;
			break;

		case OUTFIT_ADDON_BOTH:
			outfitAddonMenu = ID_TRAY_MENU_OUTFIT_ADDON_BOTH;
			break;
	}
	CheckMenuRadioItem(trayMenu,
		ID_TRAY_MENU_OUTFIT_ADDON_NONE, ID_TRAY_MENU_OUTFIT_ADDON_BOTH,
		outfitAddonMenu, MF_BYCOMMAND);

	// disable tray menu items
...
void timerChameleon(HWND hwnd)
{
	...
	// rainbow
	if (bRainbow == 1)
		setPlayerOutfitColors(rand() % MAX_OUTFIT_COLORS,
			rand() % MAX_OUTFIT_COLORS,
			rand() % MAX_OUTFIT_COLORS,
			rand() % MAX_OUTFIT_COLORS);
}
...
{
	// initialize outfit addon
	outfitAddon = getPlayerOutfitAddon();

	// initialize outfit colors
	outfitColors = getPlayerOutfitColors();
	...
	// loaded
	setStatusbarText("Chameleon for Tibia 8.30 loaded!");
}
...
void onDestroy(HWND hwnd)
{
	...
	// unloaded
	setStatusbarText("Chameleon for Tibia 8.30 unloaded!");
...
void onCommand(HWND hwnd, int command, int notifycode, HWND hwnditem)
{
	switch (command)
	{
		...
		case ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_MALE:
			outfit = OUTFIT_MALE_CITIZEN;
			setPlayerOutfitColors(OUTFIT_COLORS_NEWBIE[0], OUTFIT_COLORS_NEWBIE[1], OUTFIT_COLORS_NEWBIE[2], OUTFIT_COLORS_NEWBIE[3]);
			break;

		case ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_FEMALE:
			outfit = OUTFIT_FEMALE_CITIZEN;
			setPlayerOutfitColors(OUTFIT_COLORS_NEWBIE[0], OUTFIT_COLORS_NEWBIE[1], OUTFIT_COLORS_NEWBIE[2], OUTFIT_COLORS_NEWBIE[3]);
			break;
...
int WINAPI WinMain(HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR cmdline, int cmdshow)
{
	...
	HWND applicationWindow = FindWindow(0, "Chameleon - Tibia 8.30");
	...
	hwnd = CreateWindowEx(
		...
		"chameleon", "Chameleon - Tibia 8.30", // window class and title
