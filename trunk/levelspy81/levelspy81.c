...
const int LIGHT_AMOUNT		= 0x004D7C9C; // writeBytes 1 byte; 4D7C9B | BB 80 | MOV EBX,80
...
const int LIGHT_AMOUNT_DEFAULT = 128; // 4D7C9B | BB 80 | MOV EBX,80
const int LIGHT_AMOUNT_FULL = 255; // 4D7C9B | BB 80 | MOV EBX,80
