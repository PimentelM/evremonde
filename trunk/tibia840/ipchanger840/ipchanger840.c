...
// rsa key
#define RSA_KEY 0x005AB610

// login servers
#define LOGIN_SERVERS_BEGIN 0x0077FC48
#define LOGIN_SERVERS_END   0x007800A8 // = LOGIN_SERVERS_BEGIN + (STEP_LOGIN_SERVER * MAX_LOGIN_SERVERS)
...
int main(int argc, char *argv[])
{
    ...
    {
        MessageBox(0,
            "Usage: ipchanger840.exe ip port\nExample: ipchanger840.exe 127.0.0.1 7171",
