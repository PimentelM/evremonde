...
// rsa key
const int RSA_KEY						= 0x00597610; // 309 bytes; 1247104594268279...
...
const int TARGET_FOLLOW_TYPE			= 0x00613B3B; // CreatureType_t
...
// rsa key
const int RSA_KEY_SIZE = 309; // 309 bytes
...
{
	3608, 3609, 3613, 3614, 3615, 3616, 3617, 3618, 3619, 3620, // object ids
...
enum Flag_t
{
	...
	FLAG_PARALYZED		= 32,
	FLAG_HASTE			= 64,
	FLAG_LOGOUT_BLOCK	= 128,	// swords; in-battle
	FLAG_DROWNING		= 256,
	FLAG_FREEZING		= 512,
	FLAG_DAZZLED		= 1024,
	FLAG_CURSED			= 2048,
