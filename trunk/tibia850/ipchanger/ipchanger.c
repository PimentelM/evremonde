...
// rsa key
#define TIBIA_RSA_KEY 0x005B0610 //0x005AF610

// login servers
#define TIBIA_LOGIN_SERVERS_BEGIN 0x00786E70 //0x00785D30
#define TIBIA_LOGIN_SERVERS_END   0x007872D0 //0x00786190 // = TIBIA_LOGIN_SERVERS_BEGIN + (TIBIA_STEP_LOGIN_SERVER * TIBIA_MAX_LOGIN_SERVERS)
