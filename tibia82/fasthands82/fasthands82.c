...
void doTrayIconCreate(HWND hwnd)
{
	...
	strcpy(trayIcon.szTip, "Fast Hands - Tibia 8.2");
...
void doTrayMenuCreate(HWND hwnd)
{
	...
	AppendMenu(trayMenu, MF_STRING, ID_TRAY_MENU_NULL,				"Fast Hands - Tibia 8.2");
...
void onCreate(HWND hwnd)
{
	...
	// loaded
	setStatusbarText("Fast Hands for Tibia 8.2 loaded!");
}

void onDestroy(HWND hwnd)
{
	// unloaded
	setStatusbarText("Fast Hands for Tibia 8.2 unloaded!");
...
int WINAPI WinMain(HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR cmdline, int cmdshow)
{
	...
	HWND applicationWindow = FindWindow(0, "Fast Hands - Tibia 8.2");
	...
	hwnd = CreateWindowEx(
		...
		"fasthands", "Fast Hands - Tibia 8.2", // window class and title
