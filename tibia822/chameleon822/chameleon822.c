...
#define ID_TRAY_MENU_OUTFIT_OTHER_DEMON					1305
#define ID_TRAY_MENU_OUTFIT_OTHER_BLUE_DEMON			1306
#define ID_TRAY_MENU_OUTFIT_OTHER_PANDA					1307
#define ID_TRAY_MENU_OUTFIT_OTHER_SHEEP					1308
#define ID_TRAY_MENU_OUTFIT_OTHER_COCKROACH				1309
#define ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_MALE			1310
#define ID_TRAY_MENU_OUTFIT_OTHER_NEWBIE_FEMALE			1311
#define ID_TRAY_MENU_OUTFIT_OTHER_OLD_MALE				1312
#define ID_TRAY_MENU_OUTFIT_OTHER_OLD_FEMALE			1313
#define ID_TRAY_MENU_OUTFIT_OTHER_SWIMMING				1314
...
// outfit colors
const int OUTFIT_COLORS_NEWBIE[4] = {78, 69, 58, 76};
...
enum OutfitType
{
	...
	// set OFFSET_CREATURE_OUTFIT_HEAD to an item id then set OFFSET_CREATURE_OUTFIT to 0
...
int getPlayerOutfitAddon() { return getPlayerOffset(OFFSET_CREATURE_OUTFIT_ADDON, 1); }
