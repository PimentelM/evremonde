...
// level spy
#define LEVELSPY_NOP	0x004C4FC0 // writeNops 2 bytes; 004C4FC0 | 2BC1 | SUB EAX,ECX

#define LEVELSPY_ABOVE	0x004C4FBC // writeBytes 1 byte; 004C4FBB | B8 07 | MOV EAX,7
#define LEVELSPY_BELOW	0x004C4FC4 // writeBytes 1 byte; 004C4FC3 | B8 02 | MOV EAX,2

// name spy
#define NAMESPY_NOP		0x004DF469 // writeNops 2 bytes; 004DF469 | 75 4A | JNZ SHORT then 004DF46B | CALL 004C4FB0
#define NAMESPY_NOP2	0x004DF473 // writeNops 2 bytes; 004DF473 | 75 40 | JNZ SHORT

// show invisible creatures
#define INVISIBLE1		0x00453AF3 // writeBytes 1 byte; 00453AF3 | 72 0A | JB SHORT
#define INVISIBLE2		0x004DE734 // writeBytes 1 byte; 004DE734 | 75 09 | JNZ SHORT

// full light
#define LIGHT_NOP		0x004D7C99 // writeNops 2 bytes; 004D7C99 | 7E 05 | JLE SHORT
#define LIGHT_AMOUNT	0x004D7C9C // writeBytes 1 byte; 004D7C9B | BB 80 | MOV EBX,80

// player
#define PLAYER_Z		0x0061E9C0 // 004C4FB0 | MOV ECX,DWORD PTR DS:[61E9C0] then 004C4FB6 | CMP ECX,7
...
void trayMenuCreate(HWND hwnd)
{
	...
	AppendMenu(trayMenu, MF_STRING, ID_TRAY_MENU_NULL,				"Level Spy - Tibia 8.11");
...
int WINAPI WinMain(HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR cmdline, int cmdshow)
{
	...
	hwnd = CreateWindowEx(
		...
		"levelspy", "Level Spy - Tibia 8.11", // window class and title
