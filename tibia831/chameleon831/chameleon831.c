...
void doTrayIconCreate(HWND hwnd)
{
	...
	strcpy(trayIcon.szTip, "Chameleon - Tibia 8.31");
...
void doTrayMenuCreate(HWND hwnd)
{
	...
	AppendMenu(trayMenu, MF_STRING, ID_TRAY_MENU_NULL,									"Chameleon - Tibia 8.31");
...
void onCreate(HWND hwnd)
{
	...
	// loaded
	setStatusbarText("Chameleon for Tibia 8.31 loaded!");
}
...
void onDestroy(HWND hwnd)
{
	...
	// unloaded
	setStatusbarText("Chameleon for Tibia 8.31 unloaded!");
...
int WINAPI WinMain(HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR cmdline, int cmdshow)
{
	...
	HWND applicationWindow = FindWindow(0, "Chameleon - Tibia 8.31");
	...
	hwnd = CreateWindowEx(
		...
		"chameleon", "Chameleon - Tibia 8.31", // window class and title
